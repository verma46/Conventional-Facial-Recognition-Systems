...
#     #cv2.cvtColor(Image, NAME, (Name_X_pos, Name_y_pos - 10), cv2.FONT_HERSHEY_DUPLEX, .4, WHITE)                         # Print the name of the ID
...
def DispID(x, y, w, h, NAME, Image):
    # Define the position of the name rectangle
    Name_X_pos = x + int(w/2)
    Name_y_pos = y - 15

    # Draw the box and name rectangle
    draw_box(Image, x, y, w, h)
    ...
    cv2.putText(Image, NAME, (Name_X_pos-5, Name_y_pos-8), cv2.FONT_HERSHEY_SIMPLEX, 0.5, WHITE, 1, cv2.LINE_AA)
